    ...
    fn partial_cmp(&self, other: &Self) -> Option<Ordering> {
        match self.ordinal().cmp(&other.ordinal()) {
            ...
            Ordering::Equal => match (self, other) {
                ...
                (CubeState::DR(axis0), CubeState::DR(axis1)) if axis0 == axis1 => {
                    Some(Ordering::Equal)
                }
...
impl Cube333 {
    pub fn get_cube_state(&self) -> CubeState {
        ...
        let dr_axis: Vec<CubeAxis> = [CubeAxis::UD, CubeAxis::FB, CubeAxis::LR]
            .into_iter()
            .zip(
                [
                    Transformation333::Y,
        ...
        let fr_axis: Vec<CubeAxis> = [CubeAxis::UD, CubeAxis::FB, CubeAxis::LR]
            .into_iter()
            .zip(
                [
                    Transformation333::Y,
