...
pub fn from_step_config<'a, C: 'a>(table: &'a DRPruningTable, config: StepConfig) -> Result<(Step<'a, C>, SearchOptions), String>
    where
    ...
    eo_axis
        ...
        .flat_map(move |x| {
            let x: Option<Box<dyn StepVariant<C> + 'a>> = match x {
                (Axis::UD, Axis::FB) => Some(Box::new(DefaultPruningTableStep::<{coords::dr::DRUDEOFB_SIZE}, DRUDEOFBCoord, 2048, EOCoordFB, C>::new(&DR_UD_EO_FB_MOVESET, vec![Transformation::X], table, "drfb-eoud"))),
                (Axis::UD, Axis::LR) => Some(Box::new(DefaultPruningTableStep::<{coords::dr::DRUDEOFB_SIZE}, DRUDEOFBCoord, 2048, EOCoordFB, C>::new(&DR_UD_EO_FB_MOVESET, vec![Transformation::X, Transformation::Z], table, "drlr-eoud"))),
                (Axis::FB, Axis::UD) => Some(Box::new(DefaultPruningTableStep::<{coords::dr::DRUDEOFB_SIZE}, DRUDEOFBCoord, 2048, EOCoordFB, C>::new(&DR_UD_EO_FB_MOVESET, vec![], table, "drud-eofb"))),
                (Axis::FB, Axis::LR) => Some(Box::new(DefaultPruningTableStep::<{coords::dr::DRUDEOFB_SIZE}, DRUDEOFBCoord, 2048, EOCoordFB, C>::new(&DR_UD_EO_FB_MOVESET, vec![Transformation::Z], table, "drlr-eofb"))),
                (Axis::LR, Axis::UD) => Some(Box::new(DefaultPruningTableStep::<{coords::dr::DRUDEOFB_SIZE}, DRUDEOFBCoord, 2048, EOCoordFB, C>::new(&DR_UD_EO_FB_MOVESET, vec![Transformation::Y], table, "drud-eolr"))),
                (Axis::LR, Axis::FB) => Some(Box::new(DefaultPruningTableStep::<{coords::dr::DRUDEOFB_SIZE}, DRUDEOFBCoord, 2048, EOCoordFB, C>::new(&DR_UD_EO_FB_MOVESET, vec![Transformation::Y, Transformation::Z], table, "drfb-eolr"))),
                (_eo, _dr) => None,
            };
            x
        })
