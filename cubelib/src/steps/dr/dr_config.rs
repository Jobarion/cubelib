...
use crate::steps::dr::coords::{DRUDCoord, DRUDEOFBCoord, DRUDEOFB_SIZE, DRUD_SIZE};
use crate::steps::eo::coords::EOCoordFB;
#[cfg(feature = "333htr")]
use crate::steps::htr::htr_config::HTRSubsetTable;
use crate::steps::step::{
    DefaultPruningTableStep, DefaultStepOptions, PostStepCheck, Step, StepConfig, StepVariant,
};
...
pub type DRPruningTableStep<'a> =
    DefaultPruningTableStep<'a, { DRUDEOFB_SIZE }, DRUDEOFBCoord, 2048, EOCoordFB>;
    ...
    eo_axis
        ...
        .flat_map(move |(dr, eo)| {
            ...
            let x: Option<Box<dyn StepVariant>> = match (eo, dr) {
                (CubeAxis::UD, CubeAxis::FB) => Some(Box::new(DRPruningTableStep::new(
                    &DR_UD_EO_FB_MOVESET,
                ...
                (CubeAxis::UD, CubeAxis::LR) => Some(Box::new(DRPruningTableStep::new(
                    &DR_UD_EO_FB_MOVESET,
                ...
                (CubeAxis::FB, CubeAxis::UD) => Some(Box::new(DRPruningTableStep::new(
                    &DR_UD_EO_FB_MOVESET,
                    vec![],
                    table,
                    psc.clone(),
                ...
                (CubeAxis::FB, CubeAxis::LR) => Some(Box::new(DRPruningTableStep::new(
                    &DR_UD_EO_FB_MOVESET,
                ...
                (CubeAxis::LR, CubeAxis::UD) => Some(Box::new(DRPruningTableStep::new(
                    &DR_UD_EO_FB_MOVESET,
                ...
                (CubeAxis::LR, CubeAxis::FB) => Some(Box::new(DRPruningTableStep::new(
                    &DR_UD_EO_FB_MOVESET,
